defmodule {{MODULE_NAME}}.Commands do
  ...
  # introduce you to a cool feature that h{{MODULE_NAME}}ens under the hood.
  #
  ...
  # use.
  #
  # If you search for `defmacro send_message` at {{MODULE_NAME}}.Proxy, you'll see an
